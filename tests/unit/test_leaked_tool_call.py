"""Unit tests for _parse_leaked_tool_call: best-effort recovery of a malformed tool-call
...
def test_parse_leaked_tool_call_extracts_name_and_json_args():
    ...
    parsed = main._parse_leaked_tool_call(content)
...
def test_parse_leaked_tool_call_returns_none_without_a_match():
    assert main._parse_leaked_tool_call("這是一句普通的回答，沒有工具呼叫。") is None
